...
/// <summary>
/// A discriminated union passed to <see cref="SourceGeneratorWriter.Block"/> to represent
...
public record SourceGeneratorWriterBlock(string Text, Action Callback)
{
	...
	/// <inheritdoc cref="SourceGeneratorWriterBlock"/>
	public SourceGeneratorWriterBlock(string Text) : this(Text, default!) { }

	/// <inheritdoc cref="SourceGeneratorWriterBlock"/>
	public SourceGeneratorWriterBlock(Action Callback) : this(default!, Callback) { }

	/// <summary>Wraps a string as a text block.</summary>
	public static implicit operator SourceGeneratorWriterBlock(string text) => new(text);

	/// <summary>Wraps a callback as an action block.</summary>
	public static implicit operator SourceGeneratorWriterBlock(Action callback) => new(callback);
}
